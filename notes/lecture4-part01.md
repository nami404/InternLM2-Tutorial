...
安装好环境意味着成功了一大半！因此我们接下来就可以进入我们的第二步，准备好我们需要的数据集、模型和配置文件！
![](../images/lecture4/1716786299251.png)
### 前期准备
#### 数据集准备
为了让模型能够让模型知道在询问自己是谁的时候回复成我们想要的样子，我们就需要通过在微调数据集中大量掺杂这部分的数据。
...
```
并将文件 name 后面的内容修改为你的名称。比如说我是Nami的话就是：
```python
...
|-- data/
    ...
    |-- generate_data.py
```
![](../images/lecture4/1716786507254.png)
<font color="red" size=5>文件结构树代码如下所示</font>
...
|-- model/
    ...
    |-- tokenization_internlm2_fast.py
```
![](../images/lecture4/1716786953742.png)
...
![](../images/lecture4/1716792098733.png)
...
### 配置文件的修改
<font color="red" size="5">配置文件介绍</font>
...
```
![](../images/lecture4/1716792772831.png)
...
#### 小结
在本节我们的重点是讲解模型训练过程中的种种细节内容，包括了模型训练中的各个参数以、权重文件的选择方式以及模型续训的方法。可以看到是否使用 --work-dir 和 是否使用 --deepspeed 会对文件的保存位置以及权重文件的保存方式有所不同。那么在训练完成后，我们就可以把训练得到的 .pth 文件进行下一步的转换和整合工作了！
![](../images/lecture4/53442.png)
...
```
模型转换过程中出现的问题⚠️⚠️⚠️
![](../images/lecture4/155358.png)
要注意教程中给的命令文件名是否和自己生成的模型文件名一致，注意修改！
![](../images/lecture4/155729.png)
...
![](../images/lecture4/1716796819025.png)
...
效果图如下：
![](../images/lecture4/1716798036364.png)
![](../images/lecture4/1716798045611.png)
...
## XTuner运行原理
![](../images/lecture4/1716784505934.png)
